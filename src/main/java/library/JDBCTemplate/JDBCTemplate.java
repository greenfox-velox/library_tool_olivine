...
//    public DriverManagerDataSource getDatasource() throws URISyntaxException {
...
//    }
    ...
    public DriverManagerDataSource getDatasource() {
        DriverManagerDataSource dataSource = new DriverManagerDataSource();
        dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
        dataSource.setPassword("fa709e80");
        dataSource.setUrl("jdbc:mysql://eu-cdbr-west-01.cleardb.com/heroku_1230023ab8a6ac8?reconnect=true");
        dataSource.setUsername("b32ab3afad4bf7");
        return dataSource;
    }
